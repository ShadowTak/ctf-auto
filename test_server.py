...
<form action="/search" method="get"><input name="q"><button>Search</button></form>
    ...
    "/secret/flag.txt": b"AEGIS{hidden_dir_flag_888}\n",
    "/admin": b"<h1>Admin panel (restricted)</h1>",
    "/config.php.bak": b"<?php $db_password = 'AEGIS{backup_file_flag_999}'; ?>\n",
    "/flag.txt": b"AEGIS{root_flag_555}\n",
}
