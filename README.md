...
- flag ที่ไม่รู้จัก prefix (เช่น `redactedCTFsecret`) จะถูก **wrap เอง** เป็น `redactedCTF{secret}`
- ใช้ flag format ของเวทีนั้นๆ ได้เลย (picoCTF, HTB, redacted, ...)
