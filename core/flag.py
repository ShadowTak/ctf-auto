...
# fmt: off
_KNOWN = (
    r"flag|FLAG|Flag|ctf|CTF|picoCTF|PicoCTF|picoctf|AEGIS|aegis|AegisCTF|HTB|THM|n00bz|"
...
_NAKED_RE = re.compile(
    rf"(?<![A-Za-z0-9])(?:picoCTF|PicoCTF|AEGIS|aegis|HTB|THM|n00bz|DUCTF|FLAG|flag|CTF)[-_][A-Za-z0-9_\-]{{4,120}}"
)
